def main():
    ...
    for dd in (snow_on + snow_off):
        ...
        for rr in resolution:
            ...
            raslib.raster_merge(dem_in_dir, '.bil', dem_out_dir + dem_out_file, no_data="-9999")
            ...
            raslib.raster_merge(dem_int_in_dir, '.bil', dem_int_out_dir + dem_int_out_file, no_data="-9999")
    ...
    for dd in snow_off:
        ...
        for rr in resolution:
            ...
            hs = raslib.raster_dif_gdal(dsm_can_in, dem_int_in, inherit_from=2, dif_out=chm_out)
    ...
    for dd in snow_on:
        for intlen in interpolation_lengths:
            ...
            for rr in resolution:
                ...
                # calculate hs
                raslib.raster_merge(hs_in_dir, '.bil', hs_out_dir + hs_out_file, no_data="-9999")
    ...
    for dd in snow_on:
        for intlen in interpolation_lengths:
            for rr in resolution:
                ...
                raslib.csv_sample_raster(hs_in_path, pts_file_in, hs_uncorrected_pts_path_out, "xcoordUTM11", "ycoordUTM11", colname, sample_no_data_value='')
        ...
        for intlen in interpolation_lengths:
            for dd in snow_on_ass[ass]:
                ...
                for rr in resolution:
                    ...
                    raslib.raster_burn(swe_masked_file, snow_mask, ras.no_data)  # burn end of season snow
                    raslib.raster_burn(swe_masked_file, trail_mask, ras.no_data)  # burn trampled snow
        ...
        for intlen in interpolation_lengths:
            for rr in resolution:
                try:
                    ...
                    colname = str(dd) + '_' + str(rr) + '_' + str(intlen)
                    raslib.csv_sample_raster(hs_clean_path, pts_file_in, hs_clean_pts_path_out, "xcoordUTM11",
            ...
            for intlen in interpolation_lengths:
                for rr in resolution:
                    try:
                        ...
                        raslib.csv_sample_raster(swe_path, pts_file_in, swe_pts_path_out, "xcoordUTM11", "ycoordUTM11", colname, sample_no_data_value='')
    ...
    for dd in snow_on + snow_off:
        for rr in [".10", ".25"]:
            ...
            raslib.csv_sample_raster(point_dens_path, pts_file_in, point_dens_pts_path_out, "xcoordUTM11", "ycoordUTM11", colname, sample_no_data_value='')
    ...
    for dd in (snow_on + snow_off):
        for rr in resolution:
            for intlen in interpolation_lengths:
                ...
                raslib.csv_sample_raster(dem_path, pts_file_in, dem_pts_path_out, "xcoordUTM11", "ycoordUTM11", colname, sample_no_data_value='')
