...
data_re = rastools.pd_sample_raster(data_1, ras_1_in, ras_1_in, 'count_2', include_nans=False)
...
data_3 = rastools.pd_sample_raster(None, None, ras_3_in, 'count_3', include_nans=False)
data_re = rastools.pd_sample_raster(data_3, ras_3_in, ras_3_in, 'count_3_again', include_nans=False)
np.all(data_re.count_3 == data_re.count_3_again)

# non-nans agree when running all values here
data_re = rastools.pd_sample_raster(data_3, ras_3_in, ras_4_in, 'count_4', include_nans=False)
...
data_5 = rastools.pd_sample_raster(None, None, ras_5_in, 'id1', include_nans=False)
data_re = rastools.pd_sample_raster(data_5, ras_5_in, ras_6_in, 'id2', include_nans=False)
...
data = rastools.raster_to_pd(ras_1_in, colnames='count_1')
ras_2 = rastools.gdal_raster_reproject(ras_2_in, ras_1_in)
...
ras_m = rastools.gdal_raster_reproject(multi_in, ras_1_in)
ras_m = rastools.gdal_raster_reproject(ras_2_in, ras_1_in)