...
SET VEGETATION_HEIGHT_THRESHOLD_LOW=.05

SET NOISE_CANOPY_ISOLATION=1
SET NOISE_CANOPY_STEP_XY=.33
SET NOISE_CANOPY_STEP_Z=.33

:: call %DIR_BAT%\las_04_canopy_classification.bat


:: _____CHM [5]_____
SET CAN_RESOLUTION=.05
SET CAN_MAX_TIN_EDGE=.15
:: call %DIR_BAT%\las_05_can.bat

SET CAN_RESOLUTION=.10
SET CAN_MAX_TIN_EDGE=.30
:: call %DIR_BAT%\las_05_can.bat

SET CAN_RESOLUTION=.25
SET CAN_MAX_TIN_EDGE=.75
:: call %DIR_BAT%\las_05_can.bat

SET CAN_RESOLUTION=1.00
SET CAN_MAX_TIN_EDGE=3.00
:: call %DIR_BAT%\las_05_can.bat
...
:: call %DIR_BAT%\las_08_raster_templates.bat
SET RAS_RESOLUTION=.10
:: call %DIR_BAT%\las_08_raster_templates.bat
SET RAS_RESOLUTION=.25
:: call %DIR_BAT%\las_08_raster_templates.bat
